...
## Week 8 (Work Period Feb 25th - March 03rd)

### Tasks completed this week

- Team meetings.
- Spent a lot of time (8-10 hours) learning react this week as we are in need of custom UI react components to manage our user task flow in the library page.
- Created some starter react components in figma so that it can be used in the library page. Created filter component and search component.
- Worked with MO on sunday to clean up our project repo as it had some dead/redundant code and the project structure was really messy.
...
![text](https://i.imgur.com/des4g8a.png)
